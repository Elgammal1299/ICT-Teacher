...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://ictgate.madrasa-online.com/api/';
  }
  ...
  @override
  Future<LoginResponse> refresh(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<RegionModel> regionId(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RegionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'regions/${id}/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RegionModel _value;
    try {
      _value = RegionModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AnswersQuestionsModel> getSubmit(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AnswersQuestionsModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'quizzes/${id}/submit/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AnswersQuestionsModel _value;
    try {
      _value = AnswersQuestionsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<AccountsModel>> accounts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<AccountsModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'accounts/',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<AccountsModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => AccountsModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<AccountsIdModel> accountsId(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AccountsIdModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'accounts/${id}/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AccountsIdModel _value;
    try {
      _value = AccountsIdModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<TermModel>> terms() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TermModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'terms/',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<TermModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => TermModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<TermModel> termsId(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TermModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'terms/${id}/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TermModel _value;
    try {
      _value = TermModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
